<?php 
    ...
    //if (mysqli_connect_error($conn))
      //die("無法連線資料庫");
    $sql="select * from bulletin where bid = {$_GET['bid']}"; //從bulletin資料庫中抓bid的相關資訊
    //echo $sql;
    $result=mysqli_query($conn, $sql);//查詢資料庫中所有資訊
    $row=mysqli_fetch_array($result); //抓出要傳回的值
...
";
//表單連結bulletin_edit.php的資料 透過METHOND 屬性規定，用POST協定回傳表格資訊
//RADIO 單選按鈕，讓使用者可以做點選
//SUBMIT 表單填寫完成，提交鍵
?>
